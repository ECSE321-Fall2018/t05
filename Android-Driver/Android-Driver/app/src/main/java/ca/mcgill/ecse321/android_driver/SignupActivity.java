...
public class SignupActivity extends AppCompatActivity {
    ...
    public void addDriver(View view) {
        ...
        if(!(value.toString().equals(""))) {
            ...
            HttpUtils.post("drivers/" + "61" +"/" + value, new RequestParams(), new JsonHttpResponseHandler() {
                @Override
    ...
    public void addVehicle(View view){
        ...
        plate = editText4.getText().toString();

        if( !(value1.toString().equals("")) && !(value2.toString().equals("")) && !(value3.toString().equals("")) && !(plate.toString().equals("")) ) {


            HttpUtils.post("vehicles/" + plate + "/" + value3 + "/" + value1 + "/" +
                    value2 + "/" + "61", new RequestParams(), new JsonHttpResponseHandler() {
                @Override
                public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                    refreshErrorMessage();
                    Intent intent = new Intent(SignupActivity.this, homePageActivity.class);
